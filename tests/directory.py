...
#    driver.find_element(By.CSS_SELECTOR, 'button.button button-primary g-recaptcha'.replace(' ', '.')).click()
    ...
    # Make directory for current chapter and a file
    ...
    file_path = chapter_path + '\\content.txt'
    ...
    for unit in chapter_units:
        ...
        if file_type == 'V':
            ...
            video_url = video_url.find_element(By.TAG_NAME, 'iframe').get_attribute('src')   
...
def filter_data(unit: WebElement) -> tuple[str, bool]:
        ...
        spans = info.find_elements(By.XPATH, './/span')  
